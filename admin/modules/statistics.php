...
{"data-file":"<?php echo $chartUrlLine; ?>"} );
 ...
 swfobject.embedSWF("includes/openChart/open-flash-chart.swf", "my_chart", "550", "200", "9.0.0", "expressInstall.swf", {"data-file":"<?php echo $chartUrlBar; ?>"} );
</script>
...
<?php
   ...
   echo "<tr><td>  <a href='".ADMIN_OP."hreferer' class='colorbox'><img src='images/icon/arrow_out.png'> ". _STAT_REFERAL_LIST." </a></td></tr>\n";
    echo "</table>\n";
?>
<!--<img src='images/icon/chart_line.png'> بهترین ارجاع دهنده ها :<br> <br><?php //echo $topreferer ?></b><br><hr>
<img src='images/icon/chart_line.png'> فعال ترین اعضا :<br><br> <?php //echo $topusers ?></b><br> -->
...
highlight_file('example.php');
	...
	function Stat_Synchronization(){
		...
		?>
		<form action="<?php echo $admin_file ?>.php?op=Stat_Synchronization"  method="POST"><center>
		<?php echo _SYNCSTAT; ?><br><br>
		<img src='images/icon/accept.png'><?php echo _CHECK2WIZ ?><br><br><hr>
		<input type="hidden" name="doaction" value="1">
		<input type="submit" value="<?php echo _STAT_SYNC_START ?>"></center>
		</form>
		<?php
		}
				CloseTable();
