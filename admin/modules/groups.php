...
function Groups() {
	...
	echo "<center><font class=\"option\"><b>" . _ADDNEWGROUP . "</b></font></center><br><br>"
	    ...
	    ."<tr><td>" . _GTITLE . ":</td><td><input type=\"text\" name=\"name\" size=\"50\" maxlength=\"255\" onkeypress=\"return farsikey(this,event)\" onkeydown=changelang(this)>  <IMG src=\"images/fa2.gif\" align=\"absbottom\" style=\"CURSOR: hand\" onclick=change(name)></td></tr>"
	...
	echo "<form action=\"".$admin_file.".php\" method=\"post\">"
	    ."<td align=\"right\" nowrap>&nbsp;" . _POINTS01 . "&nbsp;</td>"
	...
	echo "<form action=\"".$admin_file.".php\" method=\"post\">"
	    ."<td align=\"right\" nowrap>&nbsp;" . _POINTS02 . "&nbsp;</td>"
	...
	echo "<form action=\"".$admin_file.".php\" method=\"post\">"
	    ."<td align=\"right\" nowrap>&nbsp;" . _POINTS03 . "&nbsp;</td>"
	...
	echo "<form action=\"".$admin_file.".php\" method=\"post\">"
	    ."<td align=\"right\" nowrap>&nbsp;" . _POINTS04 . "&nbsp;</td>"
	...
	echo "<form action=\"".$admin_file.".php\" method=\"post\">"
	    ."<td align=\"right\" nowrap>&nbsp;" . _POINTS05 . "&nbsp;</td>"
	...
	echo "<form action=\"".$admin_file.".php\" method=\"post\">"
	    ."<td align=\"right\" nowrap>&nbsp;" . _POINTS06 . "&nbsp;</td>"
	...
	echo "<form action=\"".$admin_file.".php\" method=\"post\">"
	    ."<td align=\"right\" nowrap>&nbsp;" . _POINTS07 . "&nbsp;</td>"
	...
	echo "<form action=\"".$admin_file.".php\" method=\"post\">"
	    ."<td align=\"right\" nowrap>&nbsp;" . _POINTS08 . "&nbsp;</td>"
	...
	echo "<form action=\"".$admin_file.".php\" method=\"post\">"
	    ."<td align=\"right\" nowrap>&nbsp;" . _POINTS09 . "&nbsp;</td>"
	...
	echo "<form action=\"".$admin_file.".php\" method=\"post\">"
	    ."<td align=\"right\" nowrap>&nbsp;" . _POINTS10 . "&nbsp;</td>"
	...
	echo "<form action=\"".$admin_file.".php\" method=\"post\">"
	    ."<td align=\"right\" nowrap>&nbsp;" . _POINTS11 . "&nbsp;</td>"
	...
	echo "<form action=\"".$admin_file.".php\" method=\"post\">"
	    ."<td align=\"right\" nowrap>&nbsp;" . _POINTS12 . "&nbsp;</td>"
	...
	echo "<form action=\"".$admin_file.".php\" method=\"post\">"
	    ."<td align=\"right\" nowrap>&nbsp;" . _POINTS13 . "&nbsp;</td>"
	...
	echo "<form action=\"".$admin_file.".php\" method=\"post\">"
	    ."<td align=\"right\" nowrap>&nbsp;" . _POINTS14 . "&nbsp;</td>"
	...
	echo "<form action=\"".$admin_file.".php\" method=\"post\">"
	    ."<td align=\"right\" nowrap>&nbsp;" . _POINTS15 . "&nbsp;</td>"
	...
	echo "<form action=\"".$admin_file.".php\" method=\"post\">"
	    ."<td align=\"right\" nowrap>&nbsp;" . _POINTS16 . "&nbsp;</td>"
	...
	echo "<form action=\"".$admin_file.".php\" method=\"post\">"
	    ."<td align=\"right\" nowrap>&nbsp;" . _POINTS17 . "&nbsp;</td>"
	...
	echo "<form action=\"".$admin_file.".php\" method=\"post\">"
	    ."<td align=\"right\" nowrap>&nbsp;" . _POINTS18 . "&nbsp;</td>"
	...
	echo "<form action=\"".$admin_file.".php\" method=\"post\">"
	    ."<td align=\"right\" nowrap>&nbsp;" . _POINTS19 . "&nbsp;</td>"
	...
	echo "<form action=\"".$admin_file.".php\" method=\"post\">"
	    ."<td align=\"right\" nowrap>&nbsp;" . _POINTS20 . "&nbsp;</td>"
	...
	echo "<form action=\"".$admin_file.".php\" method=\"post\">"
	    ."<td align=\"right\" nowrap>&nbsp;" . _POINTS21 . "&nbsp;</td>"
...
function grp_edit($id) {
    ...
    echo "<center><font class=\"option\"><b>" . _EDITGROUP . "</b></font></center><br><br>"
        ."<form action=\"".$admin_file.".php\" method=\"post\">"
        ."<table border=\"0\" width=\"100%\">"
        ."<tr><td>" . _GTITLE . ":</td><td><input type=\"text\" name=\"name\" size=\"50\" maxlength=\"255\" value=\"$name\" onkeypress=\"return farsikey(this,event)\" onkeydown=changelang(this)>  <IMG src=\"images/fa2.gif\" align=\"absbottom\" style=\"CURSOR: hand\" onclick=change(name)></td></tr>"
