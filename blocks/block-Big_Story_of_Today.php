...
$sql = "SELECT sid, title FROM ".$prefix."_stories WHERE (time LIKE '%$tdate%') $querylang AND time<=now() AND  section='news' AND approved='1' ORDER BY counter DESC LIMIT 0,1";
