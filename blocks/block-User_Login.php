...
if (is_user($user)) {
    ...
    $content .= "<td>"._BNICK.": <input type=\"text\" dir=ltr' name=\"username\" size=\"10\" maxlength=\"25\"><br>\n";
    $content .= ""._BPASS.": <input type=\"password\" dir=ltr' name=\"user_password\" size=\"10\" maxlength=\"20\" AutoComplete=\"off\"><br>\n";
