...
$content .='
<div style="padding: 5px;';if ($analytics->countData['uonline'] > 5) {$content .='height:100px;overflow:auto;';};$content .='">
...
$content .='
<div style="padding-left: 12px;';if ($analytics->countData['gonline'] > 5) {$content .='height:100px;overflow:auto;';};$content .='direction:rtl;text-align:right;">
