...
function poplImage(imageURL,imageTitle){
if (isNN){imgWin=window.open('about:blank','',optNN);}
if (isIE){imgWin=window.open('about:blank','',optIE);}
with (imgWin.document){
writeln('<html><head><META HTTP-EQUIV=ImageToolbar CONTENT=No><title>Loading...</title><style>body{margin:0px;}</style><body oncontextmenu="return false">');writeln('<sc'+'ript>');
