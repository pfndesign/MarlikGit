...
OpenTable();
	...
	if ($_COOKIE ['CNB_test3'] != "value3") {
		...
		echo "<td colspan=\"2\"><img src=\"modules/$module_name/images/warning.gif\" align=\"left\" width=\"40\" height=\"40\">";
...
/*************************************************************************************/
function DeleteCookies() {
global $ya_config,$module_name,$prefix,$user,$username,$CookieArray,$db;
include("header.php");
Show_CNBYA_menu();
OpenTable();
