...
// menelaos: shows top table (differently for new users and current members)
  ...
  echo "</td><td>"._YATOSINTRO1."\n";
  } else {
  echo "</td><td>"._YATOSINTRO2."\n";
  }
  echo "</td></tr></table>";
  CloseTable();
  echo "<br>";
...
// menelaos: shows bottom table (differently for new users and current members)
  ...
  echo "<P><input type=\"submit\" value='"._YA_GOBACK."'>\n";
	...
	echo "<table width=\"100%\" cellspacing=\"0\" cellpadding=\"20\" border=\"0\"><tr><td class=\"title\">";
	echo "<b>$sitename - "._YATOS1."</b>";
	echo "<P>"._YATOS2."\n";
	echo "</td></tr></table>";
	echo "</td></tr>";
	echo "<tr align=\"center\"><td width=\"100%\" valign=\"top\">\n";
	echo ""._YATOS3."<br>\n";
	echo "</td></tr><tr align=\"center\"><td width=\"100%\" valign=\"top\">";
