...
if (!defined('CNBYA')) { echo "CNBYA protection"; exit; }
	...
	if ((is_user($user)) AND (strtolower($userinfo[username]) == strtolower($cookie[1])) AND ($userinfo[user_password] == $cookie[2])) {
        ...
        echo "<textarea cols=\"55\" rows=\"5\" name=\"ublock\" onkeypress=\"return farsikey(this,event)\" onkeydown=changelang(this);>$userinfo[ublock]</textarea><br><IMG src=\"images/fa.gif\" align=\"absbottom\" style=\"CURSOR: hand\" onclick=change(ublock)>";
        echo "<br><br>";
