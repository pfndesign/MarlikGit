...
$author_user_email = "msearch@webdever.net";
$author_homepage = "http://www.webdever.net/";
$license = "GNU/GPL";
$download_location = "http://www.webdever.net/modules.php?name=Downloads&d_op=viewdownload&cid=5";
$module_version = "3.0.2";
$module_description = "Search module for PHP-Nuke";
