...
define("_LINKCOMMENTS1","Link Comments");
define("_LINKCOMMENTS2","total comments");
define("_LINKCOMMENTS3","User");
define("_LINKCOMMENTS4","Comment");
define("_LINKCOMMENTS5","Delete");
define("_LINKCOMMENTS6","No Comments");
define("_LINKCOMMENTS7","Registered User Votes");
define("_LINKCOMMENTS8","total votes");
define("_LINKCOMMENTS9","IP Address");
define("_LINKCOMMENTS10","Rating");
define("_LINKCOMMENTS11","No Registered User Votes");
define("_LINKCOMMENTS12","Total Ratings");
define("_LINKCOMMENTS13","User AVG Rating");
define("_LINKCOMMENTS14","Date");
define("_LINKCOMMENTS15","Outside User Votes");
define("_LINKCOMMENTS16","No Votes from Outside");
