...
$aid = substr("$aid", 0,25);
if (is_superadmin($admin) OR is_admin_of("Web_Links",$admin)) {
	...
	function links() {
		...
		if ($numrows>0) {
			...
			while($row4 = $db->sql_fetchrow($result4)) {
				...
				$url = check_html($row4['url'], "nohtml");
				$description = check_html($row4['description'], "");
				$name = check_html($row4['name'], "nohtml");
				$email = check_html($row4['email'], "nohtml");
				$submitter = check_html($row4['submitter'], "nohtml");
				if (empty($submitter)) {
					$submitter = _NONE;
				}
				...
				."" . _PAGETITLE . ": <input type=\"text\" name=\"title\" value=\"$title\" size=\"50\" maxlength=\"100\" onkeypress=\"return farsikey(this,event)\" onkeydown=changelang(this);> <IMG src=\"images/fa2.gif\" align=\"absbottom\" style=\"CURSOR: hand\" onclick=change(title)><br>"
				."" . _PAGEURL . ": <input type=\"text\" name=\"url\" dir=\"ltr\" value=\"$url\" size=\"50\" maxlength=\"100\">&nbsp;[ <a href=\"index.php?url=$url\" target=\"_blank\">" . _VISIT . "</a> ]<br>"
				."" . _DESCRIPTION . ": <br><textarea name=\"description\" cols=\"70\" rows=\"15\">$description</textarea><br><br>"
				."" . _NAME . ": <input type=\"text\" name=\"name\" size=\"20\" maxlength=\"100\" value=\"$name\" onkeypress=\"return farsikey(this,event)\" onkeydown=changelang(this);> <IMG src=\"images/fa2.gif\" align=\"absbottom\" style=\"CURSOR: hand\" onclick=change(name)>&nbsp;&nbsp;"
				."" . _EMAIL . ": <input type=\"text\" name=\"email\" dir=\"ltr\" size=\"20\" maxlength=\"100\" value=\"$email\"><br>";
				...
				while ($row5 = $db->sql_fetchrow($result5)) {
					...
					$ctitle2 = check_html($row5['title'], "nohtml");
		...
		."" . _NAME . ": <input type=\"text\" name=\"title\" size=\"30\" maxlength=\"100\" onkeypress=\"return farsikey(this,event)\" onkeydown=changelang(this);> <IMG src=\"images/fa2.gif\" align=\"absbottom\" style=\"CURSOR: hand\" onclick=change(title)><br>"
		."" . _DESCRIPTION . ":<br><textarea name=\"cdescription\" cols=\"70\" rows=\"15\"></textarea><br><br>"
		...
		if ($numrows>0) {
			...
			."" . _NAME . ": <input type=\"text\" name=\"title\" size=\"30\" maxlength=\"100\" onkeypress=\"return farsikey(this,event)\" onkeydown=changelang(this);>&nbsp;" . _IN . "&nbsp;";
			...
			while($row7 = $db->sql_fetchrow($result7)) {
				...
				$ctitle2 = check_html($row7['title'], "nohtml");
				$parentid2 = intval($row7['parentid']);
				if ($parentid2!=0) $ctitle2=getparent($parentid2,$ctitle2);
				echo "<option value=\"$cid2\">$ctitle2</option>";
			}
			echo "</select><br><IMG src=\"images/fa2.gif\" align=\"absbottom\" style=\"CURSOR: hand\" onclick=change(title)><br>"
			."" . _DESCRIPTION . ":<br><textarea name=\"cdescription\" cols=\"70\" rows=\"15\"></textarea><br><br>"
		...
		if ($numrows>0) {
			...
			."" . _PAGETITLE . ": <input type=\"text\" name=\"title\" size=\"50\" maxlength=\"100\" onkeypress=\"return farsikey(this,event)\" onkeydown=changelang(this);> <IMG src=\"images/fa2.gif\" align=\"absbottom\" style=\"CURSOR: hand\" onclick=change(title)><br>"
			."" . _PAGEURL . ": <input type=\"text\" name=\"url\" dir=\"ltr\" size=\"50\" maxlength=\"100\" value=\"http://\"><br>";
			$result9 = $db->sql_query("SELECT cid, title, parentid from " . $prefix . "_links_categories order by title");
			echo "" . _CATEGORY . ": <select name=\"cat\">";
			while($row9 = $db->sql_fetchrow($result9)) {
				$cid2 = intval($row9['cid']);
				 $ctitle2 = check_html($row9['title'], "nohtml");
				$parentid2 = intval($row9['parentid']);
				if ($parentid2!=0) $ctitle2=getparent($parentid2,$ctitle2);
				echo "<option value=\"$cid2\">$ctitle2</option>";
			}
			echo "</select><br><br><br>"
			."" . _DESCRIPTION255 . "<br><textarea name=\"description\" cols=\"70\" rows=\"15\"></textarea><br><br>"
			."" . _NAME . ": <input type=\"text\" name=\"name\" size=\"30\" maxlength=\"60\" onkeypress=\"return farsikey(this,event)\" onkeydown=changelang(this);> <IMG src=\"images/fa2.gif\" align=\"absbottom\" style=\"CURSOR: hand\" onclick=change(name)><br>"
			."" . _EMAIL . ": <input type=\"text\" name=\"email\" dir=\"ltr\" size=\"30\" maxlength=\"60\"><br><br>"
		...
		if ($numrows>0) {
			...
			while($row11 = $db->sql_fetchrow($result11)) {
				$cid2 = intval($row11['cid']);
				 $ctitle2 = check_html($row11['title'], "nohtml");
		...
		if ($numrows>0) {
			...
			while($row14 = $db->sql_fetchrow($result14)) {
				...
				$ctitle2 = check_html($row14['title'], "nohtml");
			...
			while($row15 = $db->sql_fetchrow($result15)) {
				...
				$ctitle2 = check_html($row15['title'], "nohtml");
	...
	function LinksModLink($lid) {
		...
		while($row = $db->sql_fetchrow($result)) {
			...
			."" . _LINKID . ": <b>$lid</b><br>"
			."" . _PAGETITLE . ": <input type=\"text\" name=\"title\" value=\"$title\" size=\"50\" maxlength=\"100\" onkeypress=\"return farsikey(this,event)\" onkeydown=changelang(this);> <IMG src=\"images/fa2.gif\" align=\"absbottom\" style=\"CURSOR: hand\" onclick=change(title)><br>"
			."" . _PAGEURL . ": <input type=\"text\" name=\"url\" dir=\"ltr\" value=\"$url\" size=\"50\" maxlength=\"100\">&nbsp;[ <a href=\"$url\">Visit</a> ]<br>"
			."" . _DESCRIPTION . ":<br><textarea name=\"description\" cols=\"70\" rows=\"15\">$description</textarea><br><br>"
			."" . _NAME . ": <input type=\"text\" name=\"name\" size=\"50\" maxlength=\"100\" value=\"$name\" onkeypress=\"return farsikey(this,event)\" onkeydown=changelang(this);> <IMG src=\"images/fa2.gif\" align=\"absbottom\" style=\"CURSOR: hand\" onclick=change(name)><br>"
			."" . _EMAIL . ": <input type=\"text\" name=\"email\" dir=\"ltr\" size=\"50\" maxlength=\"100\" value=\"$email\"><br>"
			...
			if ($recordexist == 0) {
				...
				."" . _EDITORIALTITLE . ":<br><input type=\"text\" name=\"editorialtitle\" value=\"$editorialtitle\" size=\"50\" maxlength=\"100\" onkeypress=\"return farsikey(this,event)\" onkeydown=changelang(this);> <IMG src=\"images/fa2.gif\" align=\"absbottom\" style=\"CURSOR: hand\" onclick=change(editorialtitle)><br>"
				."" . _EDITORIALTEXT . ":<br><textarea name=\"editorialtext\" cols=\"70\" rows=\"15\">$editorialtext</textarea><br><br>"
				...
				while($row3 = $db->sql_fetchrow($resulted2)) {
					...
					$editorialtext = check_html($row3['editorialtext'], "");
					$editorialtitle = check_html($row3['editorialtitle'], "nohtml");
			...
			echo "<tr><td colspan=7><b>". _LINKCOMMENTS1 ." (". _LINKCOMMENTS2 .": $totalcomments)</b><br><br></td></tr>";
			echo "<tr><td width=20 colspan=1><b>". _LINKCOMMENTS3 ."  </b></td><td colspan=5><b>". _LINKCOMMENTS4 ."  </b></td><td><b><center>". _LINKCOMMENTS5 ."</center></b></td><br></tr>";
			if ($totalcomments == 0) echo "<tr><td colspan=7><center><font color=cccccc>". _LINKCOMMENTS6 ."<br></font></center></td></tr>";
			$x=0;
			$colorswitch=$bgcolor1;
			while($row4 = $db->sql_fetchrow($result4)) {
				$ratingdbid = intval($row4['ratingdbid']);
				$ratinguser = $row4['ratinguser'];
				$ratingcomments = check_words(check_html($row4['ratingcomments'], ""));
			...
			echo "<tr><td colspan=7><br><br><b>". _LINKCOMMENTS7 ." (". _LINKCOMMENTS8 .": $totalvotes)</b><br><br></td></tr>";
			echo "<tr><td><b>". _LINKCOMMENTS3 ."  </b></td><td><b>". _LINKCOMMENTS9 ."  </b></td><td><b>". _LINKCOMMENTS10 ."  </b></td><td><b>". _LINKCOMMENTS13 ."  </b></td><td><b>". _LINKCOMMENTS12 ."  </b></td><td><b>". _LINKCOMMENTS14 ."  </b></td></font></b><td><b><center>". _LINKCOMMENTS5 ."</center></b></td><br></tr>";
			if ($totalvotes == 0) echo "<tr><td colspan=7><center><font color=cccccc>". _LINKCOMMENTS11 ."<br></font></center></td></tr>";
			$x=0;
			$colorswitch=$bgcolor1;
			while($row5 = $db->sql_fetchrow($result5)) {
				...
				$ratinghostname = check_html($row5['ratinghostname'], "nohtml");
			...
			while($row7 = $db->sql_fetchrow($result7)) {
				...
				$ratinghostname = check_html($row7['ratinghostname'], "nohtml");
			...
			echo "<tr><td colspan=7><b><br><br>". _LINKCOMMENTS15 ." (". _LINKCOMMENTS8 .": $totalvotes)</b><br><br></td></tr>";
			echo "<tr><td colspan=2><b>". _LINKCOMMENTS9 ."  </b></td><td colspan=3><b>". _LINKCOMMENTS10 ."  </b></td><td><b>". _LINKCOMMENTS14 ."  </b></td></font></b><td><b><center>". _LINKCOMMENTS5 ."</center></b></td><br></tr>";
			if ($totalvotes == 0) echo "<tr><td colspan=7><center><font color=cccccc>". _LINKCOMMENTS16 ." $sitename<br></font></center></td></tr>";
			$x=0;
			$colorswitch=$bgcolor1;
			while($row8 = $db->sql_fetchrow($result8)) {
				$ratingdbid = intval($row8['ratingdbid']);
				$rating = intval($row8['rating']);
				$ratinghostname = check_html($row8['ratinghostname'], "nohtml");
	...
	function LinksEditBrokenLinks($lid) {
		...
		$email = check_html($row2['email'], "nohtml");
		...
		."" . _PAGEURL . ": <input type=\"text\" name=\"url\" dir=\"ltr\" value=\"$url\" size=\"50\" maxlength=\"100\">&nbsp;[ <a href=\"index.php?url=$url\" target=\"_blank\">" . _VISIT . "</a> ]<br>"
		."" . _DESCRIPTION . ": <br><textarea name=\"description\" cols=\"70\" rows=\"15\">$description</textarea><br><br>"
		."" . _NAME . ": <input type=\"text\" name=\"name\" size=\"20\" maxlength=\"100\" value=\"$name\" onkeypress=\"return farsikey(this,event)\" onkeydown=changelang(this);> <IMG src=\"images/fa2.gif\" align=\"absbottom\" style=\"CURSOR: hand\" onclick=change(name)><br>&nbsp;&nbsp;"
		."" . _EMAIL . ": <input type=\"text\" name=\"email\" dir=\"ltr\" size=\"20\" maxlength=\"100\" value=\"$email\"><br>";
		echo "<input type=\"hidden\" name=\"lid\" value=\"$lid\">";
	...
	function LinksListBrokenLinks() {
		...
		if ($totalbrokenlinks==0) {
			...
			while($row = $db->sql_fetchrow($result)) {
				$requestid = intval($row['requestid']);
				$lid = intval($row['lid']);
				 $modifysubmitter = check_html($row['modifysubmitter'], "nohtml");
	...
	function LinksListModRequests() {
		...
		while($row = $db->sql_fetchrow($result)) {
			...
			$origtitle = check_words(check_html($row2['title'], "nohtml"));
			$origurl = check_html($row2['url'], "nohtml");
			$origdescription = check_words(check_html($row2['description'], ""));
			...
			$cidtitle = check_words(check_html($row3['title'], "nohtml"));
			$row5 = $db->sql_fetchrow($result5);
			$origcidtitle = check_words(check_html($row5['title'], "nohtml"));
			$row7 = $db->sql_fetchrow($result7);
			$modifysubmitteremail = check_html($row7['user_email'], "nohtml");
			$row8 = $db->sql_fetchrow($result8);
			$owneremail = check_html($row8['user_email'], "nohtml");
			if (empty($owner)) {
	...
	function LinksChangeModRequests($requestid) {
		...
		while ($row = $db->sql_fetchrow($result)) {
			...
			$title = check_words(check_html($row['title'], "nohtml"));
			$url = $row['url'];
			$description = check_words(check_html(addslashes($row['description']), "nohtml"));
	...
	function LinksModCat($cat) {
		...
		if ($cat[1]==0) {
			$row = $db->sql_fetchrow($db->sql_query("SELECT title, cdescription from " . $prefix . "_links_categories where cid='$cat[0]'"));
			 $title = check_html($row['title'], "nohtml");
			 $cdescription = check_html($row['cdescription'], "");
			echo "<form action=\"".$admin_file.".php\" method=\"get\">"
			."" . _NAME . ": <input type=\"text\" name=\"title\" value=\"$title\" size=\"51\" maxlength=\"50\" onkeypress=\"return farsikey(this,event)\" onkeydown=changelang(this);> <IMG src=\"images/fa2.gif\" align=\"absbottom\" style=\"CURSOR: hand\" onclick=change(title)><br>"
			."" . _DESCRIPTION . ":<br><textarea name=\"cdescription\" cols=\"70\" rows=\"15\">$cdescription</textarea><br><br>"
	...
	function LinksModCatS($cid, $sid, $sub, $title, $cdescription) {
	    ...
	    $sid = intval($sid);
  	    ...
  	    $cdescription = addslashes(check_words(check_html($cdescription, "")));
		if ($sub==0) {
	...
	function LinksAddEditorial($linkid, $editorialtitle, $editorialtext) {
		global $aid, $prefix, $db, $admin_file;
		 ...
		 $editorialtitle = addslashes(check_words(check_html($editorialtitle, "nohtml")));
  	     $editorialtext = addslashes(check_words(check_html($editorialtext, "")));
	...
	function LinksValidate($cid, $sid, $ttitle) {
		...
		$cid = intval($cid);
  	    $sid = intval($sid);
  	    $ttitle = check_words(check_html($ttitle, "nohtml"));
		include ("header.php");
		GraphicAdmin();
		OpenTable();
		echo "<center><font class=\"title\"><b>" . _WEBLINKSADMIN . "</b></font></center>";
		...
		while($row = $db->sql_fetchrow($result)) {
			$lid = intval($row['lid']);
		    $title = check_words(check_html($row['title'], "nohtml"));
			$url = check_words(check_html($row['url'], "nohtml"));
			$vurl = parse_url($row['url']);
			$fp = @fsockopen($vurl['host'], 80, $errno, $errstr, 2);
			if (!$fp){
			...
			if (empty($cat[1])) {
				$cat[1] = 0;
	                         ...
	                         $title = addslashes(check_words(check_html($title,"nohtml")));
  	                         ...
  	                         $name = addslashes(check_words(check_html($name,"")));
  	                         $email = addslashes(check_words(check_html($email,"")));
  	                         $email = addslashes(check_html($submitter,""));			
