...
function themenu() {
	...
	OpenTable();
	echo "<center><b>"._ADSMENU."</b><br><br>[ <a href=\"modules.php?name=$module_name\">"._MAINPAGE."</a> | ";
	//<a href=\"modules.php?name=$module_name&op=sitestats\">"._SITESTATS."</a> | 
	echo "<a href=\"modules.php?name=$module_name&op=terms\">"._TERMS."</a> | <a href=\"modules.php?name=$module_name&op=plans\">"._PLANSPRICES."</a> | $client_opt ]</center>";
	CloseTable();
}
...
function plans() {
	...
	global $pagetitle;
	$pagetitle = _ADVERTISING."-"._PLANSPRICES;
    include("header.php");
...
function terms() {
	global $pagetitle;
	$pagetitle = _ADVERTISING."-"._TERMSCONDITIONS;
    include("header.php");
    terms_content();
    themenu();
    include("footer.php");
...
function client() {
	...
	global $pagetitle;
	$pagetitle = _ADVERTISING."-"._ADSYSTEM;
	if (is_client($client)) {
		...
		echo "<td align=\"right\">"._LOGIN.":</td><td><input type=\"text\" name=\"login\" size=\"15\" dir=\"ltr\"></td></tr>";
		echo "<td align=\"right\">"._PASSWORD.":</td><td><input type=\"password\" name=\"pass\" size=\"15\" dir=\"ltr\"></td></tr>";
