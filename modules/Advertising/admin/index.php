...
$aid = substr("$aid", 0,25);
	...
	if ($c_num == 0) {
		...
		$cli = "<a class='button' href=\"".$admin_file.".php?op=add_banner\">"._ADDNEWBANNER."</a>";
	}
	...
	$ad_admin_menu_main = "<center><font class=\"title\"><b>" . _BANNERSADMIN . "</b></font><br><br>[ <a class='button' href=\"".$admin_file.".php?op=ad_positions\">"._ADPOSITIONS."</a> 
	- $cli - <a class='button' href=\"".$admin_file.".php?op=add_client\">"._ADDCLIENT."</a>
	 - <a class='button' href=\"".$admin_file.".php?op=ad_terms\">"._TERMS."</a> 
	 - <a class='button' href=\"".$admin_file.".php?op=ad_plans\">"._PLANSPRICES."</a> ]</center>$act";
	$ad_admin_menu = "<center><font class=\"title\"><b>" . _BANNERSADMIN . "</b></font><br><br>[ <a class='button' href=\"".$admin_file.".php?op=BannersAdmin\">"._BANNERS."</a> - <a class='button' href=\"".$admin_file.".php?op=ad_positions\">"._ADPOSITIONS."</a> - $cli - <a class='button' href=\"".$admin_file.".php?op=add_client\">"._ADDCLIENT."</a> - <a class='button' href=\"".$admin_file.".php?op=ad_terms\">"._TERMS."</a> - <a class='button' href=\"".$admin_file.".php?op=ad_plans\">"._PLANSPRICES."</a> ]</center>$act";
	...
	function BannersAdmin() {
		...
		if ($numrows > 0) {	
		echo "<center><h3>" . _ACTIVEBANNERS . "</h3></center><br>";
		echo"<table class='widefat comments fixed'><thead><tr>"
		."<th scope='col'><b>" . _BANNERNAME . "</b></th>"
		."<th scope='col'><b>" . _CLIENT . "</b></th>"
		."<th scope='col'><b>" . _IMPRESSIONS . "</b></th>"
		."<th scope='col'><b>" . _IMPLEFT . "</b></th>"
		."<th scope='col'><b>" . _CLICKS . "</b></th>"
		."<th scope='col'><b>" . _CLICKSPERCENT . "</b></th>"
		."<th scope='col'><b>" . _POSITION . "</b></th>"
		."<th scope='col'><b>" . _CLASS . "</b></th>"
		."<th scope='col'><b>" . _FUNCTIONS . "</b></th></tr>";
		...
		."<th scope='col'><b>" . _POSITION . "</b></th>"
		."<th scope='col'><b>" . _CLASS . "</b></th>"
		."<th scope='col'><b>" . _FUNCTIONS . "</b></th>
		</tr></tfoot><tbody>";		
		...
		echo "<center><h3>" . _INACTIVEBANNERS . "</h3></center><br>";
		echo"<table class='widefat comments fixed'><thead><tr>"
		."<th scope='col'><b>" . _BANNERNAME . "</b></th>"
		."<th scope='col'><b>" . _CLIENT . "</b></th>"
		."<th scope='col'><b>" . _IMPRESSIONS . "</b></th>"
		...
		echo "<center><h3>" . _ADVERTISINGCLIENTS . "</h3></center><br>"
		."<table class='widefat comments fixed'><thead><tr>"
		."<th scope='col'><b>" . _CLIENTNAME . "</b></th>"
		."<th scope='col'><b>" . _ACTIVEBANNERS2 . "</b></th>"
		."<th scope='col'><b>" . _INACTIVEBANNERS . "</b></th>"
		."<th scope='col'><b>" . _CONTACTNAME . "</b></th>"
		."<th scope='col'><b>" . _CONTACTEMAIL . "</b></th>"
		."<th scope='col'><b>" . _FUNCTIONS . "</b></th>
		</tr>";
	...
	function add_banner() {
		...
		addJSToHead('<script type="text/javascript">
		function newPopup(url) {
		popupWindow = window.open(			url,\'popUpWindow\',\'height=400,width=800,left=10,top=10,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no,status=yes\')}</script>','inline');
		include ("header.php");
		GraphicAdmin();
		OpenTable();
		echo "$ad_admin_menu";
		...
		if($numrows > 0) {
			...
			echo "</select></td></tr>"
			."<tr><td nowrap>" . _BANNERNAME . ":</td><td><input type=\"text\" name=\"adname\" size=\"12\" maxlength=\"50\" dir=\"ltr\"></td></tr>"
			."<tr><td nowrap>" . _PURCHASEDIMPRESSIONS . ":</td><td><input type=\"text\" name=\"imptotal\" size=\"12\" maxlength=\"11\" dir=\"ltr\"> 0 = " . _UNLIMITED . "</td></tr>"
			...
			."<tr><td>" . _IMAGESWFURL . ":</td><td><input type=\"text\" name=\"imageurl\" id=\"imageurl\" size=\"50\" maxlength=\"100\" value=\"http://\" dir=\"ltr\">
			<a href='JavaScript:newPopup(\"includes/elfinder/media.php?id=imageurl\")' ><img src='images/icon/folder_image.png'></a> </td></tr>"
			."<tr><td>" . _IMAGESIZE . ":</td><td>"._WIDTH.": <input type=\"text\" name=\"ad_width\" size=\"4\" maxlength=\"4\" dir=\"ltr\"> &nbsp; "._HEIGHT.": <input type=\"text\" name=\"ad_height\" size=\"4\" maxlength=\"4\" dir=\"ltr\"> &nbsp; "._INPIXELS."</td></tr>"
			."<tr><td>" . _CLICKURL . "</td><td><input type=\"text\" name=\"clickurl\" size=\"50\" maxlength=\"200\" value=\"http://\" dir=\"ltr\"></td></tr>"
			."<tr><td>" . _ALTTEXT . ":</td><td><input type=\"text\" name=\"alttext\" size=\"50\" maxlength=\"255\" onkeypress=\"return farsikey(this,event)\" onkeydown=changelang(this)> <IMG src=\"images/fa2.gif\" align=\"absbottom\" style=\"CURSOR: hand\" onclick=change(alttext)></td></tr>"
			."<tr><td>" . _ADCODE . ":</td><td><textarea name=\"ad_code\" rows=\"15\" cols=\"70\" dir=\"ltr\"></textarea></td></tr>"
	...
	function add_client() {
		...
		echo"<center><font class=\"title\"><b>" . _ADDCLIENT . "</b></font></center><br><br>
			<table border=\"0\"><tr><td>
			<form action=\"".$admin_file.".php?op=BannersAddClient\" method=\"post\">
			" . _CLIENTNAME . ":</td><td><input type=\"text\" name=\"name\" size=\"30\" maxlength=\"60\" onkeypress=\"return farsikey(this,event)\" onkeydown=changelang(this)> <IMG src=\"images/fa2.gif\" align=\"absbottom\" style=\"CURSOR: hand\" onclick=change(name)></td></tr>
			<tr><td>" . _CONTACTNAME . ":</td><td><input type=\"text\" name=\"contact\" size=\"30\" maxlength=\"60\" onkeypress=\"return farsikey(this,event)\" onkeydown=changelang(this)> <IMG src=\"images/fa2.gif\" align=\"absbottom\" style=\"CURSOR: hand\" onclick=change(contact)></td></tr>
			<tr><td>" . _CONTACTEMAIL . ":</td><td><input type=\"text\" name=\"email\" size=\"30\" maxlength=\"60\" dir=\"ltr\"></td></tr>
			<tr><td>" . _CLIENTLOGIN . ":</td><td><input type=\"text\" name=\"login\" size=\"12\" maxlength=\"10\" dir=\"ltr\"></td></tr>
			<tr><td>" . _CLIENTPASSWD . ":</td><td><input type=\"text\" name=\"passwd\" size=\"12\" maxlength=\"10\" value=\"$cl_pass\" dir=\"ltr\"></td></tr>
			<tr><td>" . _EXTRAINFO . ":</td><td>";
			//<textarea name=\"extrainfo\" cols=\"70\" rows=\"15\"></textarea>
			wysiwyg_textarea('extrainfo', '', 'PHPNuke', 50, 20);
			echo"</td></tr>
	...
	function BannersAdd($name, $cid, $adname, $imptotal, $imageurl, $clickurl, $alttext, $position, $active, $ad_class, $ad_code, $ad_width, $ad_height) {
		...
		$alttext = check_words(check_html(addslashes($alttext), "nohtml"));
		$cid = intval($cid);
		...
		$adname = check_words(check_html(addslashes($adname), "nohtml"));
	...
	function BannerAddClient($name, $contact, $email, $login, $passwd, $extrainfo) {
	    ...
	    $name = check_words(check_html(addslashes($name), "nohtml"));
  	    $contact = check_words(check_html(addslashes($contact), "nohtml"));
  	    $email = check_words(check_html(addslashes($email), "nohtml"));
  	    $login = check_words(check_html(addslashes($login), "nohtml"));
  	    $passwd = check_words(check_html(addslashes($passwd), "nohtml"));
  	    $extrainfo = check_words(check_html(addslashes($extrainfo)));
	...
	function BannerDelete($bid, $ok=0) {
		...
		if ($ok == 1) {
			...
			echo "<table width=\"100%\" border=\"1\"><tr>"
				."<th scope='col'><b>" . _BANNERNAME . "<b></td>"
				."<th scope='col'><b>" . _IMPRESSIONS . "<b></td>"
				."<th scope='col'><b>" . _IMPLEFT . "<b></td>"
				."<th scope='col'><b>" . _CLICKS . "<b></td>"
				."<th scope='col'><b>" . _CLICKSPERCENT . "<b></td>"
				."<th scope='col'><b>" . _CLIENTNAME . "<b></td><tr>";
			$row2 = $db->sql_fetchrow($db->sql_query("SELECT cid, name from " . $prefix . "_banner_clients where cid='$cid'"));
			$cid = intval($row2['cid']);
	...
	function BannerEdit($bid) {
		...
		while ($row3 = $db->sql_fetchrow($result3)) {
			...
			$name = check_html($row3['name'], "nohtml");
			if($cid!=$ccid) {
		...
		echo "<tr><td>"._BANNERNAME.":</td><td><input type=\"text\" name=\"adname\" size=\"20\" maxlength=\"50\" value=\"$row[name]\" dir=\"ltr\"></td></tr>";
		...
		echo "<tr><td>"._ADDIMPRESSIONS.":</td><td><input type=\"text\" name=\"impadded\" size=\"12\" maxlength=\"11\" value=\"0\" dir=\"ltr\"> <i>$unl</i></td></tr>";
		...
		if ($ad_class == "code") {
			...
			echo "<tr><td>" . _FLASHFILEURL . ":</td><td><input type=\"text\" name=\"imageurl\" size=\"50\" maxlength=\"100\" value=\"$imageurl\" dir=\"ltr\"> &nbsp; <a href=\"$imageurl\" target=\"_blank\"><img src=\"images/view.gif\" border=\"0\" alt=\""._SHOW."\" title=\""._SHOW."\"></a></td></tr>"
				."<tr><td>" . _FLASHSIZE . ":</td><td>"._WIDTH.": <input type=\"text\" name=\"ad_width\" size=\"4\" maxlength=\"4\" value=\"$ad_width\" dir=\"ltr\"> &nbsp; "._HEIGHT.": <input type=\"text\" name=\"ad_height\" size=\"4\" maxlength=\"4\" value=\"$ad_height\" dir=\"ltr\"> &nbsp; "._INPIXELS.""
				."<input type=\"hidden\" name=\"clickurl\" value=\"$clickurl\">"
				."<input type=\"hidden\" name=\"alttext\" value=\"$alttext\">"
				."<input type=\"hidden\" name=\"ad_code\" value=\"$ad_code\"></td></tr>";
		} else {
			echo "<tr><td>" . _IMAGEURL . ":</td><td><input type=\"text\" name=\"imageurl\" size=\"50\" maxlength=\"100\" value=\"$imageurl\" dir=\"ltr\">
			
			<a href='JavaScript:newPopup(\"includes/elfinder/media.php?id=imageurl\")' ><img src='images/icon/folder_image.png'></a>
			</td></tr>"
				."<tr><td>" . _IMAGESIZE . ":</td><td>"._WIDTH.": <input type=\"text\" name=\"ad_width\" size=\"4\" maxlength=\"4\" value=\"$ad_width\" dir=\"ltr\"> &nbsp; "._HEIGHT.": <input type=\"text\" name=\"ad_height\" size=\"4\" maxlength=\"4\" value=\"$ad_height\" dir=\"ltr\"> &nbsp; "._INPIXELS."</td></tr>"
				."<tr><td>" . _CLICKURL . ":</td><td><input type=\"text\" name=\"clickurl\" size=\"50\" maxlength=\"200\" value=\"$clickurl\" dir=\"ltr\"></td></tr>"
				."<tr><td>" . _ALTTEXT . ":</td><td><input type=\"text\" name=\"alttext\" size=\"50\" maxlength=\"255\" value=\"$alttext\" onkeypress=\"return farsikey(this,event)\" onkeydown=changelang(this)> <IMG src=\"images/fa2.gif\" align=\"absbottom\" style=\"CURSOR: hand\" onclick=change(alttext)>"
				."<input type=\"hidden\" name=\"ad_code\" value=\"$ad_code\"></td></tr>";
		}
	...
	function BannerClientDelete($cid, $ok=0) {
		...
		if ($ok==1) {
			...
			while ($row2 = $db->sql_fetchrow($result2)) {
				...
				$alttext = check_html($row2['alttext'], "nohtml");
	...
	function BannerClientEdit($cid) {
		...
		$extrainfo = addslashes($row['extrainfo']);
		OpenTable();
		...
		."" . _CLIENTNAME . ": <input type=\"text\" name=\"name\" value=\"$name\" size=\"30\" maxlength=\"60\" onkeypress=\"return farsikey(this,event)\" onkeydown=changelang(this)> <IMG src=\"images/fa2.gif\" align=\"absbottom\" style=\"CURSOR: hand\" onclick=change(name)><br><br>"
		."" . _CONTACTNAME . ": <input type=\"text\" name=\"contact\" value=\"$contact\" size=\"30\" maxlength=\"60\" onkeypress=\"return farsikey(this,event)\" onkeydown=changelang(this)> <IMG src=\"images/fa2.gif\" align=\"absbottom\" style=\"CURSOR: hand\" onclick=change(contact)><br><br>"
		."" . _CONTACTEMAIL . ": <input type=\"text\" name=\"email\" size=30 maxlength=\"60\" value=\"$email\" dir=\"ltr\"><br><br>"
		."" . _CLIENTLOGIN . ": <input type=\"text\" name=\"login\" size=12 maxlength=\"10\" value=\"$login\" dir=\"ltr\"><br><br>"
		."" . _CLIENTPASSWD . ": <input type=\"text\" name=\"passwd\" size=12 maxlength=\"10\" value=\"$passwd\" dir=\"ltr\"><br><br>
		" . _EXTRAINFO . ":<br>";
			//<textarea name=\"extrainfo\" cols=\"70\" rows=\"15\"></textarea>
			wysiwyg_textarea('extrainfo', ''.$extrainfo.'', 'PHPNuke', 50, 20);
			echo"<br>"
	...
	function BannerClientChange($cid, $name, $contact, $email, $extrainfo, $login, $passwd) {
	    ...
	    $name = check_words(check_html(addslashes($name), "nohtml"));
  	    ...
  	    $login = check_words(check_html(addslashes($login), "nohtml"));
  	    $passwd = check_words(check_html(addslashes($passwd), "nohtml"));
  	    $extrainfo = check_words(addslashes($extrainfo));
	...
	function ad_positions() {
		...
		echo "<br>";
		OpenTable();
		echo "<center><font class=\"title\"><b>"._CURRENTPOSITIONS."</b></font></center><br><br>
		<table class='widefat' width=\"100%\"><thead><tr>"
			."<th scope='col'><b>" . _POSITIONNAME . "<b></th>"
			."<th scope='col'><b>" . _POSITIONNUMBER . "<b></th>"
			."<th scope='col'><b>" . _ASSIGNEDADS . "<b></th>"
			."<th scope='col'><b>" . _FUNCTIONS . "<b></th></tr></thead>";
		...
		echo "<center><font class=\"title\"><b>"._ADDNEWPOSITION."</b></font><br><br>"
			...
			.""._POSITIONNAME.": <input type=\"text\" name=\"ad_position_name\" dir=\"ltr\"> "._POSITIONNUMBER.": <b>$pos_num</b><input type=\"hidden\" name=\"ad_position_number\" value=\"$pos_num\"><input type=\"hidden\" name=\"position_new\" value=\"1\"><input type=\"hidden\" name=\"op\" value=\"position_save\"><br><br><input type=\"submit\" value=\""._ADDPOSITION."\">"
			."</form></center>";
		CloseTable();
		echo "<br>";
		OpenTable();
	...
	function position_save($apid=0, $ad_position_number, $ad_position_name, $position_new=0) {
		...
		$ad_position_name = check_words(check_html(addslashes($ad_position_name), "nohtml"));
	...
	function position_edit($apid) {
		...
		echo "<center><font class=\"title\"><b>"._EDITPOSITION."</b></font><br><br>"
			...
			.""._POSITIONNAME.": <input type=\"text\" name=\"ad_position_name\" value=\"$row[position_name]\" dir=\"ltr\"> "._POSITIONNUMBER.": <b>$row[position_number]</b><input type=\"hidden\" name=\"ad_position_number\" value=\"$row[position_number]\"><input type=\"hidden\" name=\"apid\" value=\"$apid\"><input type=\"hidden\" name=\"op\" value=\"position_save\"><br><br><input type=\"submit\" value=\""._SAVEPOSITION."\">"
			."</form></center>";
		CloseTable();
		include ("footer.php");
	}
	...
	function ad_terms($save=0, $terms_body=0, $country=0) {
		...
		$save = sql_quote($_POST['save']);
		$terms_body = sql_quote($_POST['terms_body']);
		if ($save==1) {
			if (!empty($terms_body)) {
				$numrows = $db->sql_numrows($db->sql_query("SELECT * FROM ".$prefix."_banner_terms"));
				if (empty($numrows)) {
					$db->sql_query('INSERT INTO `'.$prefix.'banner_terms` (`terms_body`, `country`) VALUES ("'.$terms_body.'", "Iran")');
					Header("Location: ".$admin_file.".php?op=ad_terms");
					die();
				}else {
					$db->sql_query("UPDATE ".$prefix."_banner_terms SET `terms_body`='$terms_body'");
					Header("Location: ".$admin_file.".php?op=ad_terms");
					die();
				}
			}
			else {
				show_error("ورودی را خالی گذاشته اید . مجدد بررسی کنید");
			}		
		}
		include ("header.php");
		GraphicAdmin();
		...
		$terms_body1 = $row['terms_body'];
		echo "<center><font class=\"title\"><b>"._EDITTERMS."</b></font><br><br><i>"._SITENAMEADS."</i><br><br>"
			."<form method=\"POST\" action=\"".$admin_file.".php\">"
			.""._TERMSOFSERVICEBODY.":<br><br>";
			//<textarea name=\"terms_body\" rows=\"20\" cols=\"70\" style=\"width:100%\">$row[terms_body]</textarea><br><br>"
			wysiwyg_textarea('terms_body', $terms_body1, 'PHPNukeAdmin', 50, 20);
		
		/*	
		echo""._COUNTRYNAME.":<br><br><select name=\"country\" dir=\"ltr\">";
		...
		*/
			...
			<input type=\"hidden\" name=\"op\" value=\"ad_terms\"><br><br>
			<input type=\"submit\" name='saveAdTerms' value=\""._SAVECHANGES."\">"
	...
	function ad_plans() {
		...
		echo ""._PLANNAME.":</td><td><input type=\"text\" size=\"40\" name=\"name\" onkeypress=\"return farsikey(this,event)\" onkeydown=changelang(this);> <IMG src=\"images/fa2.gif\" align=\"absbottom\" style=\"CURSOR: hand\" onclick=change(name)></td></tr>";
		echo "<tr><td>"._PLANDESCRIPTION.":</td><td>";
		//<textarea name=\"description\" rows=\"15\" cols=\"70\"></textarea><br><IMG src=\"images/fa.gif\" align=\"absbottom\" style=\"CURSOR: hand\" onclick=change(description)>
		wysiwyg_textarea('description', '', 'PHPNuke', 50, 20);
		echo "</td></tr>";
		...
		echo "<tr><td>"._DELIVERYTYPE.":</td><td><select name=\"type\">"
			...
			."</select></td></tr>";
		echo "<tr><td>"._PRICE.":</td><td><input type=\"text\" size=\"10\" name=\"price\" dir=\"ltr\"></td></tr>";
		echo "<tr><td>"._PLANBUYLINKS.":</td><td>";
		//<textarea name=\"buy_links\" rows=\"15\" cols=\"70\" dir=\"ltr\"></textarea>
		wysiwyg_textarea('buy_links', '', 'PHPNuke', 50, 20);
		echo "</td></tr>";
	...
	function ad_plans_add($name, $description, $delivery, $type, $price, $buy_links, $status) {
		...
		if (!empty($name) AND !empty($description) AND !empty($delivery) AND (isset($type) AND is_numeric($type)) AND !empty($price) AND !empty($buy_links) AND !empty($status)) {
		    $name = check_words(check_html(addslashes($name), "nohtml"));
  	        $description = check_words(addslashes($description));
  	        $price = check_words(check_html(addslashes($price), "nohtml"));
  	        $buy_links = check_words(addslashes($buy_links));
	...
	function ad_plans_edit($pid) {
		...
		echo "<table border=\"0\"><tr><td>";
		echo "<form method=\"POST\" action=\"".$admin_file.".php\">";
		echo ""._PLANNAME.":</td><td><input type=\"text\" size=\"40\" name=\"name\" value=\"$row[name]\" onkeypress=\"return farsikey(this,event)\" onkeydown=changelang(this);> <IMG src=\"images/fa2.gif\" align=\"absbottom\" style=\"CURSOR: hand\" onclick=change(name)></td></tr>";
		echo "<tr><td>"._PLANDESCRIPTION.":</td><td>";
		//<textarea name=\"description\" rows=\"15\" cols=\"70\">$row[description]</textarea>
		wysiwyg_textarea('description', ''.$row[description].'', 'PHPNuke', 50, 20);
		echo "</td></tr>";
		...
		echo "<tr><td>"._DELIVERYTYPE.":</td><td><select name=\"type\">"
			...
			."</select></td></tr>";
		echo "<tr><td>"._PRICE.":</td><td><input type=\"text\" size=\"10\" name=\"price\" value=\"$row[price]\" dir=\"ltr\"></td></tr>";
		echo "<tr><td>"._PLANBUYLINKS.":</td><td>";
		//<textarea name=\"buy_links\" rows=\"15\" cols=\"70\" dir=\"ltr\">$row[buy_links]</textarea>
		wysiwyg_textarea('buy_links', ''.$row[buy_links].'', 'PHPNuke', 50, 20);
		echo "</td></tr>";
		if ($row[active] == 1) {
			$check0 = "checked";
			$check1 = "";
		...
		echo "<tr><td>&nbsp;</td><td><input type=\"hidden\" name=\"op\" value=\"ad_plans_save\"><input type=\"hidden\" name=\"pid\" value=\"".$pid."\"><input type=\"submit\" value=\""._SAVECHANGES."\"></td></tr></table></form><br><center><i>"._PLANSNOTE."</i></center>";
		CloseTable();
		include ("footer.php");
	}
