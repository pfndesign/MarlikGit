...
?>
	...
	<script type="text/javascript">
		...
		swfobject.embedSWF("includes/openChart/open-flash-chart.swf", "my_chart", "430", "200", "9.0.0", "expressInstall.swf", {
			"data-file": "<?php echo $chartUrlBar; ?>"
		});
	</script>
	<h3>
		<?PHP global $sitename;
		if (!defined('_STAT_TITLE'))
			define("_STAT_TITLE", "Statistics of $sitename");
		echo _STAT_TITLE . $sitename; ?>
	</h3>
