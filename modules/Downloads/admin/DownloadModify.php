...
echo "<tr><td bgcolor='$bgcolor2'>"._URL.":</td><td><input type='text' name='url' dir='ltr' value='".$lidinfo['url']."' size='50' maxlength='100'>&nbsp;[ <a href='".$lidinfo['url']."' target='new'>"._CHECK."</a> ]</td></tr>\n";
...
//<textarea name='description' cols='60' rows='10'>".$lidinfo['description']."</textarea><br><IMG src=\"images/fa.gif\" align=\"absbottom\" style=\"CURSOR: hand\" onclick=change(description)>
  wysiwyg_textarea("description", "".$lidinfo['description']."", "PHPNukeAdmin", "70", "10");
echo "</td></tr>\n";
echo "<tr><td bgcolor='$bgcolor2'>"._AUTHORNAME.":</td><td><input type='text' name='rname' size='50' onkeypress=\"return farsikey(this,event)\" onkeydown=changelang(this); maxlength='100' value='".$lidinfo['submitter']."'> <IMG src=\"images/fa2.gif\" align=\"absbottom\" style=\"CURSOR: hand\" onclick=change(rname)></td></tr>\n";
echo "<tr><td bgcolor='$bgcolor2'>"._AUTHOREMAIL.":</td><td><input type='text' dir='ltr' name='email' size='50' maxlength='100' value='".$lidinfo['email']."'></td></tr>\n";
...
echo "<tr><td bgcolor='$bgcolor2'>"._HOMEPAGE.":</td><td><input type='text' dir='ltr' name='homepage' size='50' maxlength='255' value='".$lidinfo['homepage']."'>&nbsp;[ <a href='".$lidinfo['homepage']."' target='new'>"._VISIT."</a> ]</td></tr>\n";
// USV Build 3 -- Source and Password for Downloads by Hamed -- Begin 24/09/09
echo '<tr><td bgcolor="',$bgcolor2,'">',_PASSWORD,':</td><td><input type="text" dir="ltr" name="password" size="12" value="',$lidinfo['password'],'" /></td></tr>';
echo '<tr><td bgcolor="',$bgcolor2,'">',_SOURCE,':</td><td><input type="text" dir="ltr" name="source" size="50" value="',$lidinfo['source'],'" />&nbsp;[ <a href="'.$lidinfo['source'].'" target="new">'._VISIT.'</a> ]</td></tr>';

echo '<tr><td bgcolor="',$bgcolor2,'"></td><td>';
echo $tag->input_tags('tags',$lidinfo['tags']);
echo '</td></tr>';
