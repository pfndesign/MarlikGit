...
echo "<tr><td bgcolor='$bgcolor2'>"._NAME.":</td><td><input type='text' name='title' size='50' maxlength='50' onkeypress=\"return farsikey(this,event)\" onkeydown=changelang(this); > <IMG src=\"images/fa2.gif\" align=\"absbottom\" style=\"CURSOR: hand\" onclick=change(title)></td></tr>\n";
...
echo "</select></td></tr>\n";
echo "<tr><td bgcolor='$bgcolor2' valign='top'>"._UPDIRECTORY.":</td><td><input type='text' name='uploaddir' dir='ltr' size='50' maxlength='255'><br>("._USEUPLOAD.")</td></tr>\n";
