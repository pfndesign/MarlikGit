...
define("_TAGS","tags");
define("_FILEIN","File(s) in ");
define("_DOWNLOADS_CAT_STAT"," DOWNLOADS, AND COUNTING");
define("_DOWNLOADS_WELCOME","Welcome to download section of $sitename.<br>
You can select easily from the right side category list and navigate through download files. <hr>");
define("_DOWNLOADS_TOPFILES","Newest Files");
define("_DOWNLOADS_MOSTPOP","Most Popular");
define("_DOWNLOADS_MOSTPOPTAGS","<h3>Popular Tags </h3><hr>");
