...
/********************************************************/
global $sitename;
define("_DL_TOUMUST","You <b>MUST</b> agree to the \"Terms of Use\"!");
define("_DL_TOU","Terms of Use");
define("_DUSAGEUP1","By submitting your upload you are agreeing:");
define("_DUSAGEUP2","to allow <b>$sitename</b> to host the file for download for an undetermed length of time.");
define("_DUSAGEUP3","that this agreement will serve as your \"Written\" consent for <b>$sitename</b> to host the download.");
define("_DUSAGEUP4","that the owner(s) of <b>$sitename</b> is absolved of any liability claims resulting from the use of or hosting of your upload.");
...
define("_DL_FILEEXIST","<b>ERROR:</b> This file already exists in our directory structure.");
define("_DL_NOUPLOAD","<b>ERROR:</b> File Not Uploaded.");
define("_DL_NOUPLOAD","<b>ERROR:</b> File Pertially Uploaded.");
define("_DL_TOBIG","<b>ERROR:</b> File Is To Large.");
...
define("_DUSAGE3","<font color=\"#ff0000\"><b>Site Note: This site requires membership to access this Link.</b></font>");
define("_DUSAGE4","If found to have questionable content the following WILL BE appended to the submission:");
define("_DUSAGE5","<font color=\"#0000ff\"><b>Site Note: This site contains questionable content.</b></font>");
