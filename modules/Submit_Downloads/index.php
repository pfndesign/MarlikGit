...
switch($op) {
    ...
    case "Input":
        ...
        if ($cidinfo['whoadd'] == 0 OR ($cidinfo['whoadd'] == 1 AND (is_user($user) OR is_admin($admin))) OR ($cidinfo['whoadd'] == 2 AND is_admin($admin)) OR ($cidinfo['whoadd'] > 2 AND of_group($priv))) {
            echo "<table align='center' cellpadding='2' cellspacing='2' border='0'>\n";
            ...
            echo "<tr><td align='right' bgcolor='$bgcolor2'><b>"._TITLE.":</b></td><td><input type='text' name='title' size='50' maxlength='100' onkeypress=\"return farsikey(this,event)\" onkeydown=changelang(this);> <IMG src=\"images/fa2.gif\" align=\"absbottom\" style=\"CURSOR: hand\" onclick=change(title)></td></tr>\n";
            if ($cidinfo['canupload'] == 1) {
                ...
                echo "<tr><td align='right' bgcolor='$bgcolor2'><b>"._URL.":</b></td><td><input type='file' dir='ltr' name='url' size='50'></td></tr>\n";
                $terms =  "<tr><td align='right' bgcolor='$bgcolor2'><b><a href='modules.php?name=$module_name&op=TermsUseUp' onclick=\"NewWindow(this.href,'TermsofUseUp','540','380','yes');return false;\">"._DL_TOU."</a>:</b></td>
                <td><input type='radio' name='tou' value='1'>"._YES." &nbsp; <input type='radio' name='tou' value='0' checked>"._NO."</td></tr>\n";
            } else {
                echo "<tr><td align='right' bgcolor='$bgcolor2'><b>"._URL.":</b></td><td><input type='text' dir='ltr' name='url' size='50'></td></tr>\n";
                 $terms =  "<tr><td align='right' bgcolor='$bgcolor2'><b><a href='modules.php?name=$module_name&op=TermsUse' onclick=\"NewWindow(this.href,'TermsofUse','540','380','yes');return false;\">"._DL_TOU."</a>:</b></td>
                 <td><input type='radio' name='tou' value='1'>"._YES." &nbsp; <input type='radio' name='tou' value='0' checked>"._NO."</td></tr>\n";
            }
            ...
            echo "<tr><td align='right' bgcolor='$bgcolor2' valign='top'><b>"._DESCRIPTION.":</b></td><td>";
            
            wysiwyg_textarea('description', '', 'PHPNuke', 50, 8);
            //<textarea name='description' cols='50' rows='8'></textarea><br>"._NEWLINE."<br>"._CONVERTBR."
            
            echo "</td></tr>\n";
            
             echo "<tr><td align='right' bgcolor='$bgcolor2'><b>"._VERSION.":</b></td><td><input type='text' dir='ltr' name='version' size='20' maxlength='20'></td></tr>\n";
            echo "<tr><td><hr>مشخصات شما <hr></td></tr>";
            ...
            echo "<tr><td align='right' bgcolor='$bgcolor2'><b>"._AUTHORNAME.":</b></td><td><input type='text' name='auth_name' size='50' maxlength='60' value='".$usrinfo['username']."' onkeypress=\"return farsikey(this,event)\" onkeydown=changelang(this);> <IMG src=\"images/fa2.gif\" align=\"absbottom\" style=\"CURSOR: hand\" onclick=change(auth_name)></td></tr>\n";
            echo "<input type='hidden' name='submitter' value='".$usrinfo['username']."'>\n";
            echo "<tr><td align='right' bgcolor='$bgcolor2'><b>"._AUTHOREMAIL.":</b></td><td><input type='text' dir='ltr' name='email' size='50' maxlength='100' value='".$usrinfo['user_email']."'></td></tr>\n";
            if ($cidinfo['canupload'] == 0) {
                echo "<tr><td align='right' bgcolor='$bgcolor2'><b>"._FILESIZE.":</b></td><td><input type='text' dir='ltr' name='filesize' size='20' maxlength='20'> ("._INBYTES.")</td></tr>\n";
            }

            echo "<tr><td align='right' bgcolor='$bgcolor2'><b>"._HOMEPAGE.":</b></td><td><input type='text' dir='ltr' name='homepage' size='50' maxlength='255' value='".$usrinfo['user_website']."'></td></tr>\n";
