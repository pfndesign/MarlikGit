...
/// USV- 1.0.0.0
define("_TAGS","You can add multiple tags by entering each and hiting Enter button on your keyboard");

//@		
define("_MAKEHOTSELECTED","make selected news HOT");
define("_HOTNEWS","Hot OR Not ?");
define("_NEWSREFRENCE","source title");
define("_NEWSREFRENCELINK","source link");
define("_REFRENCENEW","source");
...
define("_STORY_SECTION_SELECT","select article section");
		...
		define("_NOTOPICNAME","uncategorized");
		
		
define("_ADD_PAGE","submit_new_page");

define("_ORDERBY","Order By");
define("_ORDERBY_HIT_DESC","Hits - DESC");
define("_ORDERBY_DATE_ASC","Date - ASC");

define("_TOPICNAME","topic title");
define("_TOPICNAME1","Only one word is suggested with at most 20 letters");
define("_TOPICNAME2","e,g, newsletter");
define("_TOPICTEXT","topic description");
define("_TOPICTEXT1","(topic description , 40 letter at most)");
define("_TOPICTEXT2","(e,g. latest news in newsletter)");
