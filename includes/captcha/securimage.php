...
class Securimage {
   ...
   * @var mixed
   */
  var $gd_font_file = 'gdfonts/sfautomation.gdf';
   ...
   * @var string
   */
  var $multi_text_color = "#BB3612,#f65c47,#8d32fd";
   ...
   */
  function show($background_image = "",$l = 4)
  {
  ...
  function saveData()
  {
  if(isset($_SESSION['securimage_code_value_old']) AND $_SESSION['securimage_code_value_old'] != '')
  $_SESSION['securimage_code_value_old_old'] = $_SESSION['securimage_code_value_old'];
  if(isset($_SESSION['securimage_code_value']) AND $_SESSION['securimage_code_value'] != '')
    $_SESSION['securimage_code_value_old'] = $_SESSION['securimage_code_value'];
  ...
  function validate()
  {
    if ( (isset($_SESSION['securimage_code_value']) && !empty($_SESSION['securimage_code_value'])) ) {
      if ( ($_SESSION['securimage_code_value'] == strtolower(trim($this->code_entered))) OR ($_SESSION['securimage_code_value_old'] == strtolower(trim($this->code_entered))) OR ($_SESSION['securimage_code_value_old_old'] == strtolower(trim($this->code_entered)))) {
