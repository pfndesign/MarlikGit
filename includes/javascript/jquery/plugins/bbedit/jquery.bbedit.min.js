 ...
 */
(function($){$.bbedit={lang:{'b':'Bold','i':'Italic','u':'Underline','s':'Strike through','url':'Insert link','img':'Insert image','code':'Insert code','quote':'Insert quote','cool':'Cool','cry':'Cry','embarassed':'Embarassed','foot-in-mouth':'Foot in mouth','frown':'Frown','innocent':'Innocent','kiss':'Kiss','laughing':'Laughing','money-mouth':'Money mouth','sealed':'Sealed','smile':'Smile','surprised':'Surprised','tongue-out':'Tongue out','undecided':'Undecided','wink':'Wink','yell':'Yell'}};$.fn.extend({bbedit:function(settings){this.defaults={highlight:false,enableToolbar:true,enableSmileybar:true,smileyPath:'smiley/',tags:'b,i,u,s,url,code,quote',smilies:'cool,cry,embarassed,foot-in-mouth,frown,innocent,kiss,laughing,money-mouth,sealed,smile,surprised,tongue-out,undecided,wink,yell'}
var settings=$.extend(this.defaults,settings);var tags=settings.tags.toLowerCase().split(/,\s*/);var toolHtml='<div class="bbedit-toolbar">';for(var i in tags){toolHtml+='<span class="bbedit-'+tags[i]+'" title="'+$.bbedit.lang[tags[i]]+'">&nbsp;</span> ';}
toolHtml+='</div>';var smilies=settings.smilies.toLowerCase().split(/,\s*/);var smileyHtml='<div class="bbedit-smileybar">';for(var i in smilies){smileyHtml+='<img src="'+settings.smileyPath+'smiley-'+smilies[i]+'.gif" class="bbedit-'+smilies[i]+'" alt="'+smilies[i]+'" title="'+$.bbedit.lang[smilies[i]]+'" /> '}
