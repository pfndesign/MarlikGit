...
function install_footer(){
		...
		echo "<div style='height:100%px;padding:40px;text-align:left;font-size:10px;color:gray'>Copyright 2008-2011 <a href='http://www.nukelearn.com'>Nukelearn Group</a></div>\n";
		echo "</body>\n";
	echo "</html>\n";
}
